...
- # GAME STORY
- Past Events:
    A sight of the world 100 years before: humanity has rised to the top of civilization: people have found a solution for climate change, they now use only energy from renewable sources and they have solved world's hunger and wars problem. There is just a little extra thing that humans still don't have that will make them the perfect species: immortality. But how to accomplish that? All most famous biologists and doctors of the world have come together to make that a reality and are now working on this special virus that could be the final solution. They are really really close, but the current virus has a just little problem since it gives immortality, but it also paralyzes the victim. And, just like in the worse horror films, this virus manages to find a way to spread outside the lab it was contained in and, as we know, affect whole humanity. Wollo, which is immune (obv) to its effect, carries on his life like nothing has happened. Day by day he feels more and more lonely, but he can't do anything since he doesn't know anything about medicine. Until one day, 100 years later, the present, he discovers in the lab the TranceSmitter, thus now he has a way to learn about the world by getting in touch with humans. It begins then our adventure to save everyone;

- Our time: here is described how the game should be carried out, obviously each player will interact with it as he pleases.
The game starts in the laboratory where Wollo has just discovered the Trancesmitter [v0.0](It would be nice to have a short video about this, but it's probably too much work to do)[/v0.0], and he's talking to Dr.IDK about the game mission. Once finished, he can start explore the laboratory. Here he will find some basic tutorials on how to make recipes and energy for the lab, as well as how to find items and recipes around the world. Once the laboratory has been investigated Wollo will be able to use the teleport at the entrance of the laboratory to go in the first biome, the Forest. The other 2 biomes will be locked since they are unlockable by reaching a certain amount of energy in the laboratory. In the forest, as well as in the other biomes, Wollo will look around the map searching for 3 + 1 things:
    1. Humans: whom he can interact with in order to learn new recipes or other details about the surrounding environment;
    ...
    3. Enemies spawning in certain areas: when defeated, they drop some items necessary for recipes. Hence you have to combat them to gain the goods;
    4. "SPECIALS": at the end of each biome a legendary item will be found. This is quite important since the combination of those three, with other items, is a key element for creating the final cure. These special items are unique, once found they will not spawn anymore anywhere, but they cannot be dropped nor use for energy and they will remain in the inventory until they will be needed for the final cure's creation. In the inventory there is a special place for those.
Once one biome has been explored the player can go back to the lab and use items and recipes found there to advance in the game mission. A visited biome can be visited again to collect other of those items if needed. Once explored all the biomes, collected all the items and found all recipes, it will be time to go back in the lab and craft the cure. The very last thing to do will be to use the cure on Dr.IDK to save him. In that moment [v0.0](beside maybe a little thanks dialogue)[v0.0] the game will be finished.
...
- # THE WORLD
    ...
    - The explorable world will feature 3 biomes: **Overgrown Forest**, **Ruined City** and **Wastelands**. Wollo will have to explore each one of them to find unique items and enemies that will help him finishing his mission. [v1.0] Each biome has one special unique item, "hidden" somewhere in the map, and they are all necessary as ingredients or external components to craft the final cure. [v1.0]

    [v0.0] Possibly each biome will have a single unique item that will be found at the end of the biome exploration and that is necessary to make some specific recipe. MORE IMPORTANT, each biome will contain one special unique item "hidden" somewhere in the biomes. Those items will be needed to complete the final recipe, not as ingredients, but as external components, below they are shown in each category. [/v0.0]
    - LABORATORY:
        - Doesn't include any enemies or collectible items, but it's the place where all main activity inherent to the completion of the mission will be carried out, including the *generation of energy* for the laboratory, the *crafting* of found recipes and the *teleportation* to all other biomes.
    - OVERGROWN FOREST:
        - Collectible Items:
            - Mushrooms: they will be of 2 types, some good and some bad. Player will only recognize bad from good mushrooms if he speaks to one of the humans he will find in the forest: good mushrooms are essentials for some recipes and useful to create energy, while bad mushrooms will be only used for energy;
    ...
    - RUINED CITY:
        - Collectible Items:
            ...
            - Lubricant Oil (and possibly electronic scraps): These items will be dropped once defeated a Rogue Robot. [v1.0]  [/v1.0]
            - [v0.0] Lubricant oil will used in recipes while, but is still an idea, electronic scraps could be needed by Wollo to gain beack health after a fight. If not they will be used somehow in recipes or be dropped and not appear in the final game; [/v0.0]
        - Enemies:
            - Rogue Robots: once used to do houseworks while humans could live their lives, now this robot are gone crazy and roam the city attacking everything that moves. If players eneter in their laser field of view, they will automatically shot lasers and the combat will start. Rogue Robots will generally combat alone, and they are enough tough to teach the player a lesson, but if the player manages to trigger two or more combatments simoultaneously then the combat will be carried out with Wollo facing all enemies triggered;
        - SPECIAL CITY ITEM:
            - In the city used to stand a big temple, now fallen down. In it people used to pray a small relics with the shape of a God. Wollo is a robot and is not coded to believe in what it can't comprehend, but he knsow the statue is made with a rare material that emits certain waves that are necessary to make the final potion as it should be. Therefore, this key element won't be used as ingredient, but put on the side to channel those waves to the potion;
    - WASTELANDS:
        - Collectible Items:
            - Nuclear Scraps: nuclear scraps are so radioactive that they would mutate, or even kill istantly, any living creature (those who are not immortal, like humans around them...), but they are just harmless to a robot so technologically advanced. Nuclear scraps will be needed to create the potion since immortal humans can "digest" them too;
            - Adenithyst: special mineral that can be found only in these wastelands, generated by the combination of iron, sand and uranium mixed in really high temperatures. Wollo will need this item as pure ingredient for potions;
        - Enemies:
            - Mutant Animals: they roam the wastelands, searching for the smallest piece of food they know they will not find. Since the player goes around carrying potions and mushrooms, these mutant animals, that have a really good smell, will be attracted to Wollo and will try to attack him. Technically speaking, they differ from the wolves because wolves will be prompt to follow the player once he/she gets close enough to them, otherwise they will just don't care; Mutants, on the other hand, will attack the human as soon as they see him, so the range of collision will be much higher;
        - SPECIAL WASTELANDS ITEM:
            - These wastelands were the result of a tremendous nuclear explosion happened not long time ago, since the nuclear power plant, without humans, didn't have the required maintenance and went blowing up. Now nuclear scraps can be found all around it, but if someone manages to find his way inside the (once) power plant he will find that one nuclear reactor is still in good shape (how? I don't know, magic maybe). This reactor is the last component necessary to make the cure, and will be the container in which Wollo'll make it.
...
- ### PREFABS:
    ...
    - #### ENEMY: [v2.0]
      - This prefab contains the RigidBody2D component, the Capsule Collider 2D component and the "Enemy" script;
          - Enemy Script contains the logic for all 3 type of enemies: *chasing*, *spotting* and *detecting*, and also some of the logic that controls the spawn in the world maps, which is randomically in time and in place in specific spawn spots --this is connected with _SpawnHandler_ and _Spawn_ scripts
      ...
      - **SpawnHandler script** handles all the spawn points simultaneously [/V 2.0]
